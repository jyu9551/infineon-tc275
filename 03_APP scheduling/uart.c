...
#define ISR_PRIORITY_ASCLIN_TX 50
#define ISR_PRIORITY_ASCLIN_RX 51
#define ISR_PRIORITY_ASCLIN_ER 52
 ...
 */
IFX_INTERRUPT(asclin3TxISR, 0, ISR_PRIORITY_ASCLIN_TX); // core 0
...
void _init_uart3(void){
    ...
    ascConf.baudrate.oversampling = 15; /* Set the oversampling factor */

    /* Configure the sampling mode */
    ascConf.bitTiming.medianFilter = 1; /* Set the number of samples per bit */
    ascConf.bitTiming.samplePointPosition = 8; /* Set the first sample position */
